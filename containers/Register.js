...
//           <Text style={styles.margin}>Username</Text>
//           <TextInput
...
//             autoCapitalize="none"
//             returnKeyType="next"
//             onSubmitEditing={() => this.qfname.focus()}
//           />
//           <Text style={styles.margin}>First Name</Text>
//           <TextInput
//             ref={input => (this.qfname = input)}
//             value={this.state.firstName}
//             onChangeText={firstName => this.setState({ firstName })}
//             style={styles.input}
//             placeholderTextColor="black"
//             returnKeyType="next"
//             onSubmitEditing={() => this.qlname.focus()}
//             autoCapitalize="none"
//             autoCorrect={true}
